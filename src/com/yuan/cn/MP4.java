...
public class MP4 implements ControllerListener {
    ...
    public void play(){
        ...
        try {
            //准备一个要播放的视频文件的URL
            url = new URL("file:/E:/BaiduNetdiskDownload/Java邮件开发教程视频/张孝祥_Java邮件开发教程/04_黑马程序员张孝祥java邮件开发_邮件协议总结与邮件服务器的工作原理.avi");
